...
public class TestShiro {
    ...
    public void testShiro() {
        ...
        zhang3.setPassword("12345");            // zhang3 - 12345

        User li4 = new User();
        li4.setName("li4");
        li4.setPassword("abcde");               // li4 - abcde

        User wang5 = new User();
        wang5.setName("wang5");
        wang5.setPassword("wrongpassword");     // wang5 - wrongpassword
        ...
        roles.add(roleAdmin);
        roles.add(roleProductManager);              // roles - admin, productManager

        //权限们
        String permitAddProduct = "addProduct";
        String permitAddOrder = "addOrder";

        List<String> permits = new ArrayList<>();   // permissions - addProduct, addOrder
